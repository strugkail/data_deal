...
//		sb.append("<li class=\"disabled controls\"><span style=\"color:#999;cursor:default;background-color:transparent;\">当前 ");
//		sb.append("<input type=\"text\" value=\""+pageNo+"\" style=\"width:20px;height:15px;\" onkeypress=\"var e=window.event||event;var c=e.keyCode||e.which;if(c==13)");
//		sb.append(funcName+"(this.value,"+pageSize+",'"+funcParam+"');\" onclick=\"this.select();\"/> / ");
//		sb.append("<input type=\"text\" value=\""+pageSize+"\" style=\"width:20px;height:15px;\" onkeypress=\"var e=window.event||event;var c=e.keyCode||e.which;if(c==13)");
//		sb.append(funcName+"("+pageNo+",this.value,'"+funcParam+"');\" onclick=\"this.select();\"/> 条，");
//		sb.append("共 " + count + " 条"+(message!=null?message:"")+"</span></li>\n");
