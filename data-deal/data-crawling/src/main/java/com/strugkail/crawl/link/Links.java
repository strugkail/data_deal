package com.strugkail.crawl.link;
...
public class Links {
    ...
    //添加转化后的图片地址集合
    private static LinkedList imgPathList = new LinkedList<>();
    ...
    //添加图片地址
    public static void addImgPath(String imgPath) {
//        imgPath = imgPath.substring(1,imgPath.length());
        imgPathList.add(imgPath);
    }
    //获取路径列表
    public static LinkedList getPathList(){
        return imgPathList;
    }
    //添加到访问过的 URL
